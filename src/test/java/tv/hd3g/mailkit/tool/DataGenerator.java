/*
 * This file is part of MailKit, forked from AuthKit.
 *
...
/**
 * Update: remove setupMock methods, specific to AuthKit.
 */
public class DataGenerator {
	...
	public static Stream<String> makeRandomThings() {
		return IntStream.range(0, DataGenerator.random.nextInt(1, 20)).distinct().mapToObj(i -> {
			return makeRandomThing();
		});
	}
